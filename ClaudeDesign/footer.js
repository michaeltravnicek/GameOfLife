...
(function(){
  ...
  style.textContent = `
    ...
    .ft-label{font-family:'Barlow','Helvetica Neue',Arial,sans-serif;font-size:10px;font-weight:800;letter-spacing:.22em;text-transform:uppercase;color:rgba(255,255,255,.45);margin-bottom:14px}
    .ft-link{display:block;font-family:'Barlow','Helvetica Neue',Arial,sans-serif;font-style:italic;font-size:15px;color:rgba(255,255,255,.7);margin-bottom:6px;transition:color .15s;text-decoration:none}
    .ft-link:hover{color:#e15463}
    .ft-right{display:flex;flex-direction:column;align-items:flex-end;text-align:right}
    .ft-logo{font-family:'Bebas Neue','Arial Black',sans-serif;font-size:22px;color:#fff;letter-spacing:.06em;display:inline-flex;align-items:center;gap:8px;margin-bottom:18px}
    .ft-logo .sp{color:#e15463;font-size:14px}
    .ft-desc{font-size:13px;font-style:italic;line-height:1.7;color:rgba(255,255,255,.65);max-width:440px;margin-bottom:16px}
    .ft-contact{font-size:13px;color:rgba(255,255,255,.6);line-height:1.7}
    .ft-credit{font-size:11px;font-style:italic;color:rgba(255,255,255,.35);margin-top:14px}
